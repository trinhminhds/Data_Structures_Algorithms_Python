########### BINARY SEARCH EXERCISE SOLUTION: CODEBASE YOUTUBE CHANNEL ####################
...
################### PROBLEM 2 #######################
# Problem: Find index of all the occurrences of a number from sorted list
# Solution here tries to find an index of a number using binary search. Now since the list is sorted,
# it can do left and right scan from the initial index to find all occurrences of a given element
...
if __name__ == '__main__':
    numbers = [1, 4, 6, 8, 11, 15, 15, 15, 17, 21, 34, 34, 56]
    number_to_find = 15
